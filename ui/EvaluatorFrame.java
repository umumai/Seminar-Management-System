...
public class EvaluatorFrame extends JPanel {
    ...
    private void buildUI() {
        ...
        for (Appointment appt : apptList) {
                ...
                // green highlight = evaluated (that evaluator only) for THIS session's submission
                boolean isEvaluated = isAssignedToMe && currentUser != null &&
                    DBHelper.isStudentEvaluated(studentId, appt.getSessionID(), currentUser.getId());
                ...
                switch (time) {
                    case "9":
                        ...
                        if (isAssignedToMe) {
                            ...
                            R2C2.addActionListener(e -> showEvaluationPanel(studentId, appt.getSessionID()));
                        } else {
                    ...
                    case "10":
                        ...
                        if (isAssignedToMe) {
                            ...
                            R3C2.addActionListener(e -> showEvaluationPanel(studentId, appt.getSessionID()));
                        } else {
                    ...
                    case "11":
                        ...
                        if (isAssignedToMe) {
                            ...
                            R4C2.addActionListener(e -> showEvaluationPanel(studentId, appt.getSessionID()));
                        } else {
                    ...
                    case "12":
                        ...
                        if (isAssignedToMe) {
                            ...
                            R5C2.addActionListener(e -> showEvaluationPanel(studentId, appt.getSessionID()));
                        } else {
                    ...
                    case "13":
                        ...
                        if (isAssignedToMe) {
                            ...
                            R6C2.addActionListener(e -> showEvaluationPanel(studentId, appt.getSessionID()));
                        } else {
                    ...
                    case "14":
                        ...
                        if (isAssignedToMe) {
                            ...
                            R7C2.addActionListener(e -> showEvaluationPanel(studentId, appt.getSessionID()));
                        } else {
                    ...
                    case "15":
                        ...
                        if (isAssignedToMe) {
                            ...
                            R8C2.addActionListener(e -> showEvaluationPanel(studentId, appt.getSessionID()));
                        } else {
                    ...
                    case "16":
                        ...
                        if (isAssignedToMe) {
                            ...
                            R9C2.addActionListener(e -> showEvaluationPanel(studentId, appt.getSessionID()));
                        } else {
    ...
    private void showEvaluationPanel(String studentId, int sessionId) { 
        // umu prevent evaluator from evaluating the same student again
        if (studentId != null && DBHelper.isStudentEvaluatedByAny(studentId, sessionId)) {
        ...
        if (evaluationFrameInstance != null) {
            evaluationFrameInstance.setEvaluator(currentUser);
            evaluationFrameInstance.setCurrentStud(studentId, sessionId);
        }
