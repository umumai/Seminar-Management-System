...
public class EvaluationFrame extends JPanel {
    ...
    private void submitEvaluation() {
        ...
        if (currentSessionId == null) {
            JOptionPane.showMessageDialog(this, "Missing session information for this evaluation.");
            return;
        }
        // Display for double evaluation
        if (DBHelper.isStudentEvaluatedByAny(currentStudentId, currentSessionId)) {
    ...
    // Session-scoped evaluation: ensures the correct submission is evaluated
    public void setCurrentStud(String studentId, int sessionId) {
        this.currentSessionId = sessionId;
        setCurrentStud(studentId);
    }
}
